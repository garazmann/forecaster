...
{
    #[Route('/json/{id}', name: 'app_weather_api_json')]
    ...
    #[Route('/jsont/{id}', name: 'app_weather_api_jsont')]
    ...
    #[Route('/csvt/{id}', name: 'app_weather_api_csvt')]
    ...
    #[Route('/serializer/{id}', name: 'app_weather_api_serializer')]
...
//        return $response;
    ...
    #[Route('/forecast/{id}/{date}', name: 'app_weather_api_patch')] 
